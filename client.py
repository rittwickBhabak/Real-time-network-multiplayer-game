...
if __name__=='__main__':
    ...
    if client_number=='1':
        client = Client("10.237.22.145", 30001, "10.194.38.53", 20000, "Rittwick 1", False)
    elif client_number=='2':
        client = Client("10.237.22.145", 30002, "10.194.38.53", 20000, "Rittwick 2", False)
    elif client_number=='3':
        client = Client("10.237.22.145", 30003, "10.194.38.53", 20000, "Rittwick 3", True, 2)
    elif client_number=='4':
        client = Client("10.237.22.145", 30004, "10.194.38.53", 20000, "Rittwick 4", True, 5)
    elif client_number=='5':
        client = Client("10.237.22.145", 30005, "10.194.38.53", 20000, "Rittwick 5", True, 10)
    else:
